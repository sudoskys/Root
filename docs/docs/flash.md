...
为避免“刷机”带来的**安全风险**，保护用户权益，[《关于进一步规范移动智能终端应用软件预置行为的通告》]((https://www.gov.cn/zhengce/2022-12/15/content_5732078.htm))要求生产企业完善移动智能终端权限管理机制，提升操作系统安全性，采取技术和管理措施预防“刷机”行为。
:::
